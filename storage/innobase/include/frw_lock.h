...
#pragma once
#ifdef SAFE_MUTEX
# define FRW_LOCK_DUMMY
#endif

#ifdef __linux__
# define FRW_LOCK_DUMMY /* FIXME: remove this, and fix the hangs */
#endif

/* #undef FRW_LOCK_DUMMY */

#include "univ.i"

#if defined FRW_LOCK_DUMMY || (!defined _WIN32 && !defined __linux__)
#else
# ifdef _WIN32
#  include <windows.h>
# else
...
class frw_lock final
#if defined __linux__ && !defined FRW_LOCK_DUMMY
  : protected rw_lock
#endif
{
#if defined FRW_LOCK_DUMMY || (!defined _WIN32 && !defined __linux__)
